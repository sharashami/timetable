...
INSERT INTO `program` VALUES (1,'CIÊNCIA DA COMPUTAÇÃO',1,1),(2,'TÉCNICO EM INFORMÁTICA',1,1);
...
--
-- Table structure for table `oferta_course`
--

DROP TABLE IF EXISTS `oferta_course`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
